...
public class ProductDTO {
	...
	private String delive_price; //배송비 
	...
	private String prod_filename; //상품 파일명
	private String thumbnail_img; //상품썸네일 이미지
	private String thumbnail_filename; //상품 썸네일 파일명
	private int prod_quan;  //수량
	private String add_product; //추가상품명
	private String prod_reg_date; //상품등록일
	private String prod_keyword; //상품키워드
	private int mem_num ;  // 회원번호
	private String prod_cate; //상품분류
	...
	public String getDelive_price() {
		return delive_price;
	}
	public void setDelive_price(String delive_price) {
	...
	public String getProd_reg_date() {
		return prod_reg_date;
	}
	public void setProd_reg_date(String prod_reg_date) {
